...
import { DEFAULT_PACKAGE_IDS, DEFAULT_WALRUS_URLS, DEFAULT_SUI_GRPC_URLS } from '../../types/config.js';
...
describe('Config Utils', () => {
  describe('validateConfig', () => {
    ...
    it('should use default package ID for network', () => {
      ...
      expect(result.packageId).toBe('0x1f520a412cee6d8fb76f66bb749e1e14b2476375bc7c892d103c82f6cedf0d85'); // Latest testnet deployment with seal_approve
    });
    ...
    it('should use default Walrus URLs for network', () => {
      ...
      expect(result.walrusPublisherUrl).toBe(DEFAULT_WALRUS_URLS.testnet.publisher);
      expect(result.walrusAggregatorUrl).toBe(DEFAULT_WALRUS_URLS.testnet.aggregator);
    });
